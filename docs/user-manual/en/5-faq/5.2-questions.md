...
CC Switch for macOS is code-signed and notarized by Apple. You can download and install it directly without any additional steps. If you encounter issues, try downloading the latest version from the [Releases page](https://github.com/yaoliwen542-sketch/cc-switch/releases).
...
1. Visit [GitHub Issues](https://github.com/yaoliwen542-sketch/cc-switch/issues)
